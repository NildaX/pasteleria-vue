...
export default createStore({
  state: {
    estadoenvio: " ",
    existenciasP:[
      {id:0,nombre:"Chocolate",cantidad:"10"},
      {id:1,nombre:"Fresa",cantidad:"7"},
      {id:2,nombre:"Tres leches",cantidad:"8"},
      {id:3,nombre:"Platano",cantidad:"9"},
      {id:4,nombre:"Chessecake",cantidad:"10"},
    ],
    existenciasA:[
      {id:5,nombre:"Galletas",cantidad:"15"},
      {id:6,nombre:"Gomitas",cantidad:"15"},
      {id:7,nombre:"Gelatina",cantidad:"15"},
      {id:8,nombre:"Frutos rojos",cantidad:"10"},
      {id:9,nombre:"M&M",cantidad:"5"},
    ],
    pedidos:[
